class SshXTerm < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/eugeniofciuvasile/ssh-x-term/releases/download/v2.0.8/ssh-x-term-darwin-arm64"
      sha256 "8d14c9eb7f97ea41289222eb7ec5c478fa33691bcbe7514bf13d4ea173179d35"
    else
      url "https://github.com/eugeniofciuvasile/ssh-x-term/releases/download/v2.0.8/ssh-x-term-darwin-amd64"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/eugeniofciuvasile/ssh-x-term/releases/download/v2.0.8/ssh-x-term-linux-arm64"
      sha256 "bf3e7bc929fc938108595b8c078e036c1d9fe951c0da786cfce3d4bdb40f02b7"
    else
      url "https://github.com/eugeniofciuvasile/ssh-x-term/releases/download/v2.0.8/ssh-x-term-linux-amd64"
